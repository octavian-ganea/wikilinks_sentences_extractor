...
public class WikiLinkItem implements org.apache.thrift.TBase<WikiLinkItem, WikiLinkItem._Fields>, java.io.Serializable, Cloneable, Comparable<WikiLinkItem> {
  ...
  public WikiLinkItem(WikiLinkItem other) {
    ...
    if (other.isSetRare_words()) {
      List<RareWord> __this__rare_words = new ArrayList<RareWord>(other.rare_words.size());
    ...
    if (other.isSetMentions()) {
      List<Mention> __this__mentions = new ArrayList<Mention>(other.mentions.size());
  ...
  public int compareTo(WikiLinkItem other) {
    ...
    lastComparison = Boolean.valueOf(isSetRare_words()).compareTo(other.isSetRare_words());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetRare_words()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.rare_words, other.rare_words);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
