...
public class PageContentItem implements org.apache.thrift.TBase<PageContentItem, PageContentItem._Fields>, java.io.Serializable, Cloneable, Comparable<PageContentItem> {
  ...
  public int compareTo(PageContentItem other) {
    ...
    lastComparison = Boolean.valueOf(isSetDom()).compareTo(other.isSetDom());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetDom()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.dom, other.dom);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
