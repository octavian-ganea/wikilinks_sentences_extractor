...
@Generated(value = "Autogenerated by Thrift Compiler (1.0.0-dev)", date = "2013-11-13")
public class Mention implements org.apache.thrift.TBase<Mention, Mention._Fields>, java.io.Serializable, Cloneable, Comparable<Mention> {
  ...
  public int compareTo(Mention other) {
    ...
    lastComparison = Boolean.valueOf(isSetWiki_url()).compareTo(other.isSetWiki_url());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetWiki_url()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.wiki_url, other.wiki_url);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetAnchor_text()).compareTo(other.isSetAnchor_text());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetAnchor_text()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.anchor_text, other.anchor_text);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetRaw_text_offset()).compareTo(other.isSetRaw_text_offset());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetRaw_text_offset()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.raw_text_offset, other.raw_text_offset);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    ...
    lastComparison = Boolean.valueOf(isSetFreebase_id()).compareTo(other.isSetFreebase_id());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetFreebase_id()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.freebase_id, other.freebase_id);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
